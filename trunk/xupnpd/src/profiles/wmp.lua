profiles['wmp']=
{
    ...
    ['match']=function(user_agent) if string.find(user_agent,'Windows-Media-Player',1,true) or string.find(user_agent,'NSPlayer',1,true) then return true else return false end end,
